...
from scripts.MultiQuestionQueryEngine import MultiQuestionQueryEngine
...
#7.  Do the multiquery version
multiQuestionQueryEngine = MultiQuestionQueryEngine()
multiQuestionQueryEngine.process_questions(config_instance, "questions2.json", "results2.json")
