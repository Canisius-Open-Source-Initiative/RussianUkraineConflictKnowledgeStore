...
def createCSV():
    print("1. Extract hyperlinks from PDF")
...
#6. Run vector store with persisted knowledge search
#vectorStoreAsContextPersisted.demo(config_instance.chroma_db_persist, config_instance.pdfs_folder, config_instance.jsons_folder, config_instance.nsa_csv_timeline, config_instance.openai_api_key)